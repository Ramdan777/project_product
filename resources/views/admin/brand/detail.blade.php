...
<body class=".bg-body-secondary">
    ...
    <nav class="navbar navbar-dark bg-dark mb-3">
        <div class="container-fluid">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href='admin.brand.index' class="btn btn-secondary me-md-2">Back</a>
            </div>
        </div>
    </nav>
    ...
    {{-- <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
            ...
            <div class="row justify-content-center">
                    <div class="col-md-4">
                        <div class="card style="width: 18rem;">
                            <img src="{{ asset('storage/photo/' . $brand->image) }}" class="card-img-top" alt=".">
                            <div class="card-body">
                                <h6 class="card-title">{{ $brand->name }}</h6>
                                <p class="card-text">web address : {{$brand->web_address}}</p>
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                @foreach ($brand->product_brand as $data)
                    <div class="col-md-4">
                        <div class="card style="width: 18rem;">
