...
<body class="bg-light">
    ...
    <div class="container">
        <h1 class="mt-4 text-center">Ini Halaman Brand</h1>

        <div class="mt-3 mb-5 d-flex justify-content-end">
            <a href="admin.brand.create" class="btn btn-success">Add Brand</a>
        </div>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                @foreach ($brand as $data)
                    <tr>
                        <td>{{ $loop->iteration + $brand->firstItem() - 1 }}</td>
                        <td>{{ $data->name }}</td>
                        <td>{{ $data->web_address }}</td>
                        <td>
                            <a href='admin.brand.detail.{{ $data->id }}' class="btn btn-primary btn-sm">
                                View
                            </a>
                            <a href='admin.brand.edit.{{ $data->id }}' class="btn btn-success btn-sm">
                            ...
                            <form class="d-inline" action="admin-delete.brand.{{ $data->id }}" method="post"
