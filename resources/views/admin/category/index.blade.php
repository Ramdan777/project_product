...
<body class="bg-light">
    ...
    <div class="container">
        <h1 class="mt-4 text-center">Ini Halaman Category</h1>
            ...
            <tbody>
                @foreach ($category as $data)
                    <tr>
                        ...
                        <td>{{ $data->name }}</td>
                        <td>
                            <a href='admin.category.detail.{{ $data->id }}' class="btn btn-primary btn-sm">
                                View
                            </a>
                            <a href='admin.category.edit.{{ $data->id }}' class="btn btn-success btn-sm">
                            ...
                            <form class="d-inline" action="admin-delete.category.{{ $data->id }}" method="post"
